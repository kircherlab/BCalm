...
version: "`r Githubpkg('kircherlab/BCalm')` (v`r packageVersion('BCalm')`)"
...
# Citing BCalm
To cite the BCalm package please use [@bcalm]. When using BCalm you can additionally cite the `mpra` package [@mpralm] and the limma-voom framework [@voom].
...
The package is also available on GitHub and can be installed using remotes [@remotes] or devtools [@devtools].
