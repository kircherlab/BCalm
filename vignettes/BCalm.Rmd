...
plot_groups(mpralm_fit_elem, 0.95, neg_label="liverMPRA_(-)", test_label="ProximalPromoterDesign")
```
...
```{r MPRA treat}
result <- mpra_treat(mpralm_fit_elem, 0.95, neg_label="liverMPRA_(-)", test_label="ProximalPromoterDesign", side="both")
head(result)
```
